...
---@field finder? obsidian.config.Picker Deprecated: use picker.name.
---@field finder_mappings? obsidian.config.PickerNoteMappingOpts Deprecated: use picker.note_mappings.
---@field preferred_link_style? obsidian.link.LinkStyle Deprecated: use link.style.
---@field detect_cwd? boolean Deprecated: removed.
---@field open_app_foreground? boolean Deprecated: use open.func.
---@field use_advanced_uri? boolean Deprecated: use open.use_advanced_uri.
---@field overwrite_mappings? boolean Deprecated: removed.
---@field mappings? table Deprecated: removed.
---@field tags? table Deprecated: removed.
---@field image_name_func? fun(): string Deprecated: use attachments.img_name_func.
---@field note_frontmatter_func? fun(note: obsidian.Note): table<string, any> Deprecated: use frontmatter.func.
---@field disable_frontmatter? boolean|fun(fname: string?): boolean Deprecated: use frontmatter.enabled.
---@field search_max_lines? integer Deprecated: use search.max_lines.
---@field sort_by? obsidian.config.SortBy|false Deprecated: use search.sort_by.
---@field sort_reversed? boolean Deprecated: use search.sort_reversed.
---@field follow_url_func? function Deprecated: removed.
---@field follow_img_func? function Deprecated: removed.
---@field wiki_link_func? function Deprecated: use link.style.
---@field markdown_link_func? function Deprecated: use link.style.
