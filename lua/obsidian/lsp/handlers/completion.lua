...
local Attachment = require "obsidian.completion.sources.attachments"
...
return function(params, callback, _)
  ...
  local pending = 4 -- refs + tags + footnotes + attachments always run
  ...
  -- Attachments source.
  Attachment.process_completion(on_source_done, request)
