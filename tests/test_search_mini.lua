...
T["find_tags"]["should find positions of all tags"] = function()
  ...
  eq({ { 1, 5, "Tag" }, { 16, 23, "Tag" } }, M.find_tags_in_line(s))
end

T["find_tags"]["should find four cases"] = function()
  eq(1, #M.find_tags_in_line "#camelCase")
  eq(1, #M.find_tags_in_line "#PascalCase")
  eq(1, #M.find_tags_in_line "#snake_case")
  eq(1, #M.find_tags_in_line "#kebab-case")
end

T["find_tags"]["should find nested tags"] = function()
  eq(1, #M.find_tags_in_line " #inbox/processing")
  eq(1, #M.find_tags_in_line " #inbox/to-read")
end

T["find_tags"]["should ignore escaped tags"] = function()
  local s = "I have a #meeting at noon \\#not-a-tag"
  eq({ { 10, 17, RefTypes.Tag } }, M.find_tags_in_line(s))
  s = [[\#notatag]]
  eq({}, M.find_tags_in_line(s))
end
