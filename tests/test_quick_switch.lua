...
T["quick switch"]["passes config to find notes"] = function()
  ...
  local original_find_notes = picker.find_notes
  local captured
  ...
  picker.find_notes = original_find_notes
...
T["quick switch"]["cache picker filters attachments and missing links"] = function()
  ...
  eq({ attachment = false, missing = false }, attachment_seen["Note"])
